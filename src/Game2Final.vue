    ...
    return {
        ...
        myGamePiece:  {
            ...
            crashWith : (otherobj) => {
                ...
                var crash = true;
                if ((mybottom < othertop) || (mytop > otherbottom) || (myright-20 < otherleft) || (myleft+30 > otherright)) {
                    crash = false;
                }
                return crash;
            },
            move : () => {
                if(this.myGamePiece.x <= this.myStickPiece.width+(this.myGamePiece.width*3.3)) {
